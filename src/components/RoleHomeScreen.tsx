/**
 * Sanskriti Pre School — Role Home Screen
 *
 * Shared placeholder dashboard for parent / teacher / admin. The full
 * feature set per role ships in Phase 2–4 (see analysis_and_roadmap.md).
 * Uses the iOS-style top nav bar via ScreenHeader so the theme toggle
 * is always visible.
 */
...
export function RoleHomeScreen({ role }: RoleHomeScreenProps) {
  ...
  return (
    <ScreenShell>
      <ScreenHeader title={Brand.schoolName} subtitle={getRoleLabel(role)} />
      <ScrollView
